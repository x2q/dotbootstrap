...
layout: post
published: true
title: Track file downloads and outgoing links with Google Analytics
permalink: /track-file-downloads-and-outgoing-links-with-google-analytics/
wordpress_id: 832
categories:
- News
- apache
...
- outgoing links
- avi
- Google Analytics Extender Javascript
---


Using this Google Analytics Extender Javascript you can easily track file downloads and outgoing links with <a href="http://www.google.com/analytics/">Google Analytics</a>.
